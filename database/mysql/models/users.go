...
var UserTableColumns = struct {
	...
	AccessLevel: "users.access_level",
...
var UserWhere = struct {
	...
	AccessLevel: whereHelperint{field: "`users`.`access_level`"},
...
var (
	userAllColumns            = []string{"user_id", "username", "name", "password", "access_level", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "name", "password"}
	userColumnsWithDefault    = []string{"user_id", "access_level", "created_at", "updated_at"}
